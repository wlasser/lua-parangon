...
CharDBQuery(
    "CREATE TABLE IF NOT EXISTS `" ..
        Parangon.Config.dbName ..
            "`.`account_parangon` (`accountid` int(11) NOT NULL, `level` int(11) DEFAULT 1, `exp` int(11) DEFAULT 0,PRIMARY KEY (`accountid`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;"
)
CharDBQuery(
    "CREATE TABLE IF NOT EXISTS `" ..
        Parangon.Config.dbName ..
            "`.`characters_parangon` (`accountid` int(11) NOT NULL,`guid` int(11) NOT NULL, `strenght` int(11) NOT NULL DEFAULT 0, `agility` int(11) NOT NULL DEFAULT 0, `stamina` int(11) NOT NULL DEFAULT 0, `intellect` int(11) NOT NULL DEFAULT 0, PRIMARY KEY (`accountid`,`guid`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;"
)
...
function Parangon.getParangon(event, player)
    ...
    if (not (Parangon.Stats[pGuid])) then
        --
        local getParangonStats =
            CharDBQuery(
            "SELECT strenght, agility, stamina, intellect FROM `" ..
                Parangon.Config.dbName ..
                    "`.characters_parangon WHERE guid = " .. pGuid .. " AND accountid = " .. pAccid .. ";"
        )
        --

        if (not (getParangonStats)) then
            local setParangonStats =
                CharDBExecute(
                "INSERT INTO `" ..
                    Parangon.Config.dbName ..
                        "`.characters_parangon (accountid, guid) VALUES (" .. pAccid .. ", " .. pGuid .. ");"
            )
    ...
    if (not (Parangon.Infos[pAccid])) then
        --
        local getParangonInfo =
            CharDBQuery(
            "SELECT level, exp FROM `" ..
                Parangon.Config.dbName .. "`.account_parangon WHERE accountid = " .. pAccid .. ";"
        )
        --

        if (not (getParangonInfo)) then
            local setParangonInfo =
                CharDBExecute(
                "INSERT INTO `" .. Parangon.Config.dbName .. "`.account_parangon (accountid) VALUES (" .. pAccid .. ");"
            )
    ...
    Parangon.Infos[pAccid].points =
        ((Parangon.Infos[pAccid].level * Parangon.Config.pointsPerLevel) - Parangon.Stats[pGuid][7464] -
        Parangon.Stats[pGuid][7471] -
        Parangon.Stats[pGuid][7477] -
        Parangon.Stats[pGuid][7468])
...
function Parangon.setParangon(event, player)
    ...
    local setParangonStats =
        ...
        "UPDATE `" ..
            Parangon.Config.dbName ..
                "`.characters_parangon SET strenght = " ..
                    Parangon.Stats[pGuid][7464] ..
                        ", agility = " ..
                            Parangon.Stats[pGuid][7471] ..
                                ", stamina = " ..
                                    Parangon.Stats[pGuid][7477] ..
                                        ", intellect = " ..
                                            Parangon.Stats[pGuid][7468] ..
                                                " WHERE guid = " .. pGuid .. " AND accountid = " .. pAccid .. ";"
    )
    local setParangonInfo =
        CharDBExecute(
        "UPDATE `" ..
            Parangon.Config.dbName ..
                "`.account_parangon SET level = " ..
                    Parangon.Infos[pAccid].level ..
                        ", exp = " .. Parangon.Infos[pAccid].exp .. " WHERE accountid = " .. pAccid .. ";"
    )
  ...
  Parangon.setStatsIncrease
...
]] function Parangon.setStatsIncrease(
    player,
    stat,
    value)
    ...
    elseif (player:GetLevel() < Parangon.Config.minLevel) then
        player:SendNotification(
            "You can't do this right now, you have to be level " .. Parangon.Config.minLevel .. " minimum."
        )
    else
        local pGuid = player:GetGUIDLow()
        local pAccid = player:GetAccountId()
...
]] function Parangon.setParangonLevelUp(
    event,
    player)
    local pAccid = player:GetAccountId()
...
function Parangon.onGossipHello(event, player, object)
        ...
        "      " ..
            player:GetName() ..
                "'s Parangon\n\nLevel : " ..
                    Parangon.Infos[pAccid].level ..
                        "\n\nExperience : " ..
                            Parangon.Infos[pAccid].exp ..
                                "\nMax Experience : " ..
                                    Parangon.Config.maxExp * Parangon.Infos[pAccid].level ..
                                        "\n\n" ..
                                            Parangon.Config.space ..
                                                Parangon.Config.space ..
    ...
    player:GossipMenuAddItem(
        4,
        "|CFF9100BC(" .. Parangon.Stats[pGuid][7464] .. ")|r |- Strenght",
        1,
        7464,
        false,
        "|CFFC20000/!\\ WARNINGS! /!\\\n\n|r You currently have " ..
            Parangon.Stats[pGuid][7464] .. " points of strength\nYou will add +1 to you stat.\n\nAre you sure?"
    )
    player:GossipMenuAddItem(
        4,
        "|CFF9100BC(" .. Parangon.Stats[pGuid][7471] .. ")|r |- Agility",
        1,
        7471,
        false,
        "|CFFC20000/!\\ WARNINGS! /!\\\n\n|r You currently have " ..
            Parangon.Stats[pGuid][7471] .. " points of agility\nYou will add +1 to you stat.\n\nAre you sure?"
    )
    player:GossipMenuAddItem(
        4,
        "|CFF9100BC(" .. Parangon.Stats[pGuid][7477] .. ")|r |- Stamina",
        1,
        7477,
        false,
        "|CFFC20000/!\\ WARNINGS! /!\\\n\n|r You currently have " ..
            Parangon.Stats[pGuid][7477] .. " points of stamina\nYou will add +1 to you stat.\n\nAre you sure?"
    )
    player:GossipMenuAddItem(
        4,
        "|CFF9100BC(" .. Parangon.Stats[pGuid][7468] .. ")|r |- Intellect",
        1,
        7468,
        false,
        "|CFFC20000/!\\ WARNINGS! /!\\\n\n|r You currently have " ..
            Parangon.Stats[pGuid][7468] .. " points of intellect\nYou will add +1 to you stat.\n\nAre you sure?"
    )
